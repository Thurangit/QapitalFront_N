...
const metiers = [
    ...
    "Jardinier", "Cuisinier", "Informaticien", "Designer", "Traducteur",
    "Photographe", "Chauffeur", "Professeur", "Coiffeur", "Esthéticien"
];
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={handleInputChange}
                                className="w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Ex: https://exemple.com/details-supplementaires"
                            />
                    ...
                    <div className="mt-6 flex justify-between">
                        ...
                        {step < totalSteps ? (
                            ...
                            <button
                                ...
                                onClick={handleSubmit}
                                disabled={loading}
                                className="px-4 py-2 bg-green-600 text-white rounded-lg flex items-center gap-1 hover:bg-green-700 disabled:bg-green-300"
                            >
                                {loading ? (
                                    <>
